      ...
      <div className="container mx-auto px-6 py-3">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <Link href="/">
              <svg className="h-16 w-16 p-1 fill-current border rounded border-current transition-colors durstion-300 ease-in-out hover:fill-cyan-500 hover:border-cyan-800 hover:animate-pulse" viewBox="0 0 8 4" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="md:hidden flex items-center">
            <button
              className="mobile-menu-button flex items-center px-3 py-2 transition-color duration-300 ease-in-out hover:text-cyan-500"
