...
const Navbar = () => {
  ...
  return (
    <nav className="fixed w-full z-10 backdrop-blur-3xl">
      <div className="container mx-auto px-6 py-3">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <Link href="/">
              <svg className="h-16 w-16 p-1 fill-white border rounded border-white transition-colors durstion-300 ease-in-out hover:fill-cyan-500 hover:border-cyan-800" viewBox="0 0 8 4" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* mobile menu */}
      <div className="hidden md:hidden mobile-menu fixed right-0 w-1/2 bg-gradient-to-r from-cyan-800 to-black">
