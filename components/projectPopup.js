...
const ProjectPopup = ({ project, closePopup }) => {
  return (
    <div className="project-popup fixed z-10 top-2 left-0 w-full h-full flex justify-center items-center backdrop-blur-md">
      <div className="project-popup-inner absolute opacity-90 m-7 w-fit  h-fit backdrop-blur-xl rounded-lg shadow-lg overflow-hidden">
        <button onClick={closePopup} className="absolute top-0 right-0 mt-4 mr-4 text-cyan-500 hover:text-teal-600 hover:scale-110 p-1 backdrop-blur-3xl rounded-md">
